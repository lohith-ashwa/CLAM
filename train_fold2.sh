...
#SBATCH --output=/data/pathology/projects/lohith/logs/slurm-clam-f2-%j.out
#SBATCH --error=/data/pathology/projects/lohith/logs/slurm-clam-f2-%j.err
...
# ── Train CLAM-SB on Fold 2 (your Fold 3) ──
