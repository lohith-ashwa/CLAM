...
#SBATCH --output=/data/pathology/projects/lohith/logs/slurm-clam-f1-%j.out
#SBATCH --error=/data/pathology/projects/lohith/logs/slurm-clam-f1-%j.err
...
# ── Train CLAM-SB on Fold 1 (your Fold 2) ──
