...
CUDA_VISIBLE_DEVICES=0 python3 eval.py \
    --k 15 \
    --models_exp_code bone_sex_clam_sb_virchow2_6_s1 \
    --save_exp_code bone_sex_eval_6 \
    --task bone_sex \
    --model_type clam_sb \
    --data_root_dir /data/pathology/projects/lohith \
    --embed_dim 2560 \
    --results_dir /data/pathology/projects/lohith/clam_results \
    --splits_dir /data/pathology/projects/lohith/clam_results/bone_sex_clam_sb_virchow2_6_s1
